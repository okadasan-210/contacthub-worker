// .wrangler/tmp/bundle-eaCQgJ/checked-fetch.js
...
app.post(
  ...
  (context) => {
    ...
    return context.json({ message: "/company\u30EB\u30FC\u30C8\u306B\u5BFE\u3057\u3066POST\u3057\u307E\u3057\u305F" });
  }
).get("/kv-test", async (context) => {
...
// src/index.ts
var app2 = new Hono2();
app2.route("/companies", company_default);
var src_default = {
  async fetch(request, env, context) {
    return app2.fetch(request, env, context);
  }
};
...
// .wrangler/tmp/bundle-eaCQgJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eaCQgJ/middleware-loader.entry.ts
